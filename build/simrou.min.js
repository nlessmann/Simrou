...
if(""!==b)return this.resolve(b,"get");if(null!=a)return null!=window.history&&null!=window.history.replaceState?(window.history.replaceState({},document.title,"#"+a.replace(/^#+/,"")),this.resolve(a,"get")):this.navigate(a)};c.prototype.stop=function(){$(window).off("hashchange",this.resolveHash);this.observingHash=!1;$("body").off("submit","form",this.handleFormSubmit);return this.observingForms=!1};return c}();g=function(){function c(b){this.pattern=b;b instanceof RegExp?this.expr=b:null!=b?(b=
(""+b).replace(this.escapeRegExp,"\\$&"),b=b.replace(this.namedParam,"([^/]+)"),b=b.replace(this.splatParam,"(.*?)"),this.expr=RegExp("^"+b+"$")):this.expr=/^.+$/}var a;c.prototype.escapeRegExp=/[-[\]{}()+?.,\\^$|#\s]/g;c.prototype.namedParam=/:\w+/g;c.prototype.splatParam=/\*\w*/g;c.prototype.firstParam=/(:\w+)|(\*\w*)/;c.prototype.match=function(b){b=this.expr.exec(b);return $.isArray(b)?b.slice(1):!1};c.prototype.assemble=function(){var b,a,c,e;e=1<=arguments.length?k.call(arguments,0):[];if(this.pattern instanceof
RegExp)throw"Assembling routes that are based on a regular expression is not supported.";0<e.length&&$.isArray(e[0])&&(e=e[0]);a=this.pattern;for(b=0;this.firstParam.test(a);)c=null!=e[b]?$.isFunction(e[b])?e[b]():""+e[b]:"",a=a.replace(this.firstParam,c),b++;return a};c.prototype.getRegExp=function(){return this.expr};c.prototype.attachAction=function(b,a){null==a&&$.isFunction(b)&&(a=b,b="*");return $(this).on("simrou:"+b.toLowerCase(),a)};c.prototype.attachActions=function(b,a){var c,e,f,a=$.isArray(b)?
{"*":b}:$.isPlainObject(b)?b:new function(){return this[b]=a};f=[];for(b in a)h.call(a,b)&&(e=a[b],$.isArray(e)||(e=[e]),f.push(function(){var a,d,f;f=[];a=0;for(d=e.length;a<d;a++)c=e[a],f.push(this.attachAction(b,c));return f}.call(this)));return f};c.prototype.detachAction=function(b,a){var c;null==a&&$.isFunction(b)&&(a=b,b="*");c="simrou:"+b.toLowerCase();return $.isFunction(a)?$(this).off(c,a):$(this).off(c)};a=function(a){return function(c){return this.attachAction(a,c)}};c.prototype.get=a("get");
c.prototype.post=a("post");c.prototype.put=a("put");c.prototype["delete"]=a("delete");return c}();window.Simrou=i}).call(this);
