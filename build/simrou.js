  ...
  Simrou = (function() {
    ...
    function Simrou(initialRoutes) {
      ...
      this.handleFormSubmit = function(event) {
        return Simrou.prototype.handleFormSubmit.apply(_this, arguments);
      };
      this.resolveHash = function(event) {
        return Simrou.prototype.resolveHash.apply(_this, arguments);
      };
      this.routes = {};
    ...
    Simrou.prototype.addTraveller = function(object) {
      var i, key, _results;
      _results = [];
      for (i in object) {
        key = i.replace(/\ +?/g, '');
        _results.push(this.travelLounge[key] = object[i]);
      }
      return _results;
    };

    Simrou.prototype.travelBegins = function() {
      var history, lounge;
      history = this.history;
      history = history.toString();
      lounge = this.travelLounge;
      if (history in lounge) {
        return lounge[history]();
      }
    };
    ...
    Simrou.prototype.saveHistory = function(hash) {
      this.history.push(hash.replace(/#/, '').toString());
    ...
    Simrou.prototype.resolveHash = function(event) {
      ...
      if (this.observeHash) {
        ...
        this.saveHistory(hash);
        this.resolve(hash, 'get');
        return this.travelBegins();
      }
    };
