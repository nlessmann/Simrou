...
(function() {
    ...
    Simrou.prototype.listen = function() {
      ...
      if (!this.listening) {
        return jQuery(function() {
          jQuery(window).on('hashchange.simrou', _this.resolveHash);
          jQuery('body').on('submit.simrou', 'form', _this.handleFormSubmit);
  ...
  Route = (function() {
    ...
    Route.prototype.attachAction = function(action, method) {
      ...
      return jQuery(this).on('simrou:' + method.toLowerCase(), action);
    };
    ...
    Route.prototype.detachAction = function(action, method) {
      ...
      if (jQuery.isFunction(action)) {
        return jQuery(this).off(eventName, action);
      } else {
        return jQuery(this).off(eventName);
      }
    };
